                ...
                <div class="block wow fadeInUp" data-wow-delay=".3s">
                    ...
                    <section class="cd-intro">
                        <h1 class="wow fadeInUp animated cd-headline slide" data-wow-delay=".4s" >
                            <span>HI, MY NAME IS FERDAUS MOMAND & I AM A</span><br>
                            <span class="cd-words-wrapper">
                                    <b class="is-visible">${translator}</b>
                                    <b>${interpreter}</b>
                                    <b>${migration_specialist}</b>
                                </span>
                        </h1>
                    </section> <!-- cd-intro -->
                    <!-- /.slider -->
...
<section id="works" class="works">
    <div class="container">
        <div class="section-heading">
            <h1 class="title wow fadeInDown" data-wow-delay=".3s"><c:out value="${latest_works}"></c:out></h1>
...
<section id="call-to-action">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="block">
                    <h2 class="title wow fadeInDown" data-wow-delay=".3s" data-wow-duration="500ms"> <c:out value="${so_what_you_think}"></c:out> </h2>
                        <p class="wow fadeInDown" data-wow-delay=".5s" data-wow-duration="500ms">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis,<br>possimus commodi, fugiat magnam temporibus vero magni recusandae? Dolore, maxime praesentium.</p>
                        <a href="${path}/contact${lang}" class="btn btn-default btn-contact wow fadeInDown" data-wow-delay=".7s" data-wow-duration="500ms"><c:out value="${contact_with_me}"></c:out></a>
                </div>
            </div>
